...
for file in excel_files:
    ...
    data[file] = (mem, avrg_pr)

# 设置绘图
plt.figure(figsize=(10, 6))
i = 0
# 为每个文件绘制曲线
for file, (mem, avrg_pr) in data.items():
    plt.plot(mem, avrg_pr, label=name[i], marker='o')  # 'o' 是标记的类型
    i += 1
...
plt.ylabel('PR',fontproperties=font_prop)

# 显示图形
plt.savefig('./result/tmp_pr.png',dpi=350)