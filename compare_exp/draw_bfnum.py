...
bf_num = selected_data['bf_num'].values
...
data[file] = (bf_num, avrg_are)

# 设置绘图
plt.figure(figsize=(10, 6))
plt.plot(bf_num, avrg_are, label=name, marker='o')  # 'o' 是标记的类型

# 添加图例
plt.legend()

# 添加标题和轴标签
plt.xlabel('bf_num',fontproperties=font_prop)
plt.ylabel('ARE',fontproperties=font_prop)

# 显示图形
plt.savefig('./result/tmp_bf_num.png',dpi=350)